...
export default function Landing() {
  ...
  useEffect(() => {
    // Relying on `ready` state from useStore below.
  }, []);
  ...
  return (
    <div className="relative min-h-screen overflow-x-hidden bg-transparent">
      ...
      {/* ==================================================== */}
      <div className="flex md:hidden h-[100dvh] pt-[env(safe-area-inset-top,3rem)] pb-[env(safe-area-inset-bottom,0px)] flex-col relative overflow-hidden z-50">
        
        {/* Top Header */}
        <div className="absolute top-0 inset-x-0 w-full flex items-center gap-3 px-6 pt-[calc(env(safe-area-inset-top,3rem)+2rem)] z-50">
        ...
        >
            ...
            <div className="min-w-full relative overflow-hidden flex flex-col justify-end p-8 pb-40">
              ...
              <div className="relative z-10 flex flex-col justify-end">
                ...
                <p className="font-hanken text-lg text-neutral-200">Crack 11th, 12th, MHT-CET, JEE & NEET with a system, not stress.</p>
              </div>
            </div>
      ...
      <div className="hidden md:block min-h-screen">
            ...
            >
              ...
              >
                <span className="glassy inline-flex items-center gap-2 rounded-full px-5 py-2.5 font-geist text-label-sm text-neutral-800 dark:text-neutral-200">
                  <Sparkles size={14} className="text-purple-600 dark:text-purple-400" /> SKCTI Spatial Interface
                </span>
        ...
        <footer className="relative z-10 border-t border-black/5 dark:border-white/5 py-10 text-center">
          <p className="font-geist text-body-sm text-black dark:text-neutral-400 mb-4">© {new Date().getFullYear()} {cfg.appName} · Built for Indian Competitive Exams</p>
      ...
      <AnimatePresence>
        {showLogin && (
          ...
          >
            {/* Top Header */}
            <div className="absolute top-[calc(env(safe-area-inset-top,3rem)+2rem)] left-6 flex items-center gap-3 z-50">
            ...
            <button 
              ...
              className="absolute top-[calc(env(safe-area-inset-top,3rem)+2rem)] right-6 z-50 p-2 rounded-full bg-black/5 dark:bg-white/10 backdrop-blur-md hover:scale-110 transition-transform"
            >
            ...
            <div className="hidden md:flex flex-1 relative items-center justify-center bg-gradient-to-br from-purple-900/50 to-blue-900/50 overflow-hidden">
              ...
              <div className="relative z-10 p-12 max-w-lg text-center">
                ...
                <p className="font-hanken text-xl text-neutral-300">Crack 11th, 12th, MHT-CET, JEE & NEET with a system, not stress.</p>
              </div>
            </div>
            ...
            <div className="flex-1 flex items-center justify-center p-6 relative">
              <motion.div 
                ...
                className="w-full max-w-sm text-center pt-32 pb-16 md:pt-40 md:pb-24"
              >
