  ...
  return (
    <div className="grid min-h-[100dvh] place-items-center p-6">
      <div className="glassy-strong rounded-glass max-w-sm p-8 text-center">
        ...
        <h1 className="font-sora text-xl font-bold text-neutral-900 dark:text-white">
          Back in a few minutes
        </h1>
        <p className="font-hanken text-body-md mt-2 text-neutral-500 dark:text-neutral-400">
          {m.message}
        </p>
        <button
          onClick={() => window.location.reload()}
          className="press glassy mt-6 w-full rounded-full py-3 font-geist text-sm font-bold text-neutral-900 dark:text-white"
        >
          Try again
        </button>
      </div>
