    ...
    <AnimatePresence>
      {open && (
        <>
          ...
          >
            ...
            >
              ...
              <div className="flex flex-col items-center text-center mt-4">
                ...
                <h2 className="font-sora text-2xl font-bold text-on-surface mb-2">{title}</h2>
          ...
          >
            <div className="flex items-center gap-4 px-4 py-4 bg-surface-container backdrop-blur-xl border-b border-white/10 sticky top-0 z-10">
              <button
                onClick={() => { vibrate(10); onClose(); }}
              ...
              <h1 className="font-sora font-semibold text-lg text-on-surface">{title}</h1>
            </div>
            ...
            <div className="flex-1 flex flex-col items-center justify-center p-8 text-center">
              ...
              <motion.h2
                ...
                className="font-sora text-3xl font-bold text-on-surface mb-3 tracking-tight"
              >
                Coming Soon
              </motion.h2>
              <motion.p
