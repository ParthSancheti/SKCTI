...
export function ChapterSkeleton() {
  return (
    <div className="bg-surface-container backdrop-blur-xl border border-white/10 rounded-3xl p-8 space-y-4 shadow-xl">
...
export function TestSkeleton() {
  return (
    <div className="bg-surface-container backdrop-blur-xl border border-white/10 rounded-3xl p-8 flex items-center gap-4 shadow-xl">
      <div className="w-12 h-12 bg-white/10 animate-pulse border border-white/5 rounded-2xl" />
      <div className="flex-1 space-y-2">
...
export function RowSkeleton() {
  return (
    <div className="bg-surface-container backdrop-blur-xl border border-white/10 rounded-2xl p-6 flex items-center gap-4 mx-6 shadow-md">
