  ...
  return (
    <>
      <motion.header 
        ...
        className="sticky top-[env(safe-area-inset-top,0px)] lg:top-6 mt-[env(safe-area-inset-top,0px)] lg:mt-6 z-40 mx-2 lg:mx-0 mb-4 px-3 py-1.5 glassy rounded-full flex items-center justify-between shadow-sm"
      >
